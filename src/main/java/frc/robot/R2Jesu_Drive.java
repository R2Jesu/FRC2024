...
public class R2Jesu_Drive {
  ...
  private double switchPpid = 0.010;//maura we added a zero 0.025
  private double switchIpid = 0.0;
  private double switchDpid = 0.0;
  private double pidOutput1 = 0.0;
  private double pidOutput2 = 0.0;
  private double pidOutput3 = 0.0;
  private double pidOutput4 = 0.0;
  private double switchPidOutput = 0.0;
  ...
  private double conversion = 360.0/3.3;
